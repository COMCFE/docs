...
```json
{
    ...
    "data": {
        "ipfs": {   /*矿池数据*/
         ...
         "eth": {   /*矿池数据*/
                    "network_computing_power": "320693",// 全网算力
            "current_computing_difficulty": "21.72", // 当前算力难度
            "current_currency_price": "306049.47",// 当前币价
            "every_m_output_per_day": "0.00000658" // 预计日产出
                },
                 "btc": {   /*矿池数据*/
                            "network_computing_power": "320693",// 全网算力
                "current_computing_difficulty": "21.72", // 当前算力难度
